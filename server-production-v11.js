/* v11: v10 user journey, KRC/card APIs, pilot metrics, and server-side contact-PII rejection. */
...
if(!source.includes('contactPii')||!source.includes('/api/pilot/feedback'))throw new Error('Privacy endpoint insertion failed.');
